//  Create a JavaScript Promise
     ...
     // function, so you need to use the new keyword to create one. It takes a
     // function, as its argument, with two parameters - resolve and reject. These
     // are methods used to determine the outcome of the promise. The syntax looks
     // like this:
...
//  Assignment:
//     Make the promise handle success and failure. If responseFromServer is true, call the
//     resolve method to successfully complete the promise. Pass resolve a string with the
//     value We got the data. If responseFromServer is false, use the reject method
...
//     in your code (i.e. something asynchronous), often a server request. When you make a
//     server request it takes some amount of time, and after it completes you usually want
//     to do something with the response from the server. This can be achieved by using the
//     then method. The then method is executed immediately after your promise is fulfilled
