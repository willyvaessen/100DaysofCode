...
const BinaryDecoder = require('mariadb/lib/cmd/decoder/binary-decoder');
const TextDecoder = require('mariadb/lib/cmd/decoder/text-decoder');
const OkPacket = require('mariadb/lib/cmd/class/ok-packet');
const StateChange = require('mariadb/lib/const/state-change');
