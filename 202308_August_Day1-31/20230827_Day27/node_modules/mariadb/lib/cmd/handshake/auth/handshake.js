const PluginAuth = require('mariadb/lib/cmd/handshake/auth/plugin-auth');
const InitialHandshake = require('mariadb/lib/cmd/handshake/auth/initial-handshake');
const Collations = require('mariadb/lib/const/collations');
const ClientCapabilities = require('mariadb/lib/cmd/handshake/client-capabilities');
const Capabilities = require('mariadb/lib/const/capabilities');
const SslRequest = require('mariadb/lib/cmd/handshake/ssl-request');
...
const driverVersion = require('mariadb/package.json').version;
