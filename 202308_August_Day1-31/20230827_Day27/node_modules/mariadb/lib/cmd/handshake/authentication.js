...
const Handshake = require('mariadb/lib/cmd/handshake/auth/handshake');
const authenticationPlugins = {
  mysql_native_password: require('mariadb/lib/cmd/handshake/auth/native-password-auth.js'),
  mysql_clear_password: require('mariadb/lib/cmd/handshake/auth/clear-password-auth'),
  client_ed25519: require('mariadb/lib/cmd/handshake/auth/ed25519-password-auth'),
  dialog: require('mariadb/lib/cmd/handshake/auth/pam-password-auth'),
  sha256_password: require('mariadb/lib/cmd/handshake/auth/sha256-password-auth'),
  caching_sha2_password: require('mariadb/lib/cmd/handshake/auth/caching-sha2-password-auth')
};
